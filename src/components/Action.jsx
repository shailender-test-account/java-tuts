...
function Action() {
  ...
  return (
    <section className="py-5 relative px-[30px] md:px-0">
        ...
        <motion.div variants={myvariants} initial="hidden" whileInView={"visible"} transition={{duration:3 , ease:"easeInOut" , type:"spring"}}  viewport={{ once: true }} className="container m-auto p-12 grid gap-4 grid-cols-5 border-2 bg-[#17cf97] border-none rounded-lg">
