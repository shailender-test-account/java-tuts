...
const Footer = () => {
  return (
    <footer className="py-6 bg-[#1b2430] text-[white] ">
            ...
            >
              <div className="grid grid-cols-1 items-center">
                ...
                <div className="pt-14 flex justify-center md:justify-normal">
                  <p className="text-lg font-mono text-center sm:text-left text-slate-400 tracking-[2px] w-[75%]">Empowering the Next Generation of Java Geniuses with Innovative Tutorials</p>
                </div>
              </div>
            </a>
          </div>
            ...
            <ul className="p-0 sm:text-left">
              <li className="py-[8px] flex justify-center sm:justify-normal">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:text-[#17cf97] text-slate-400"
                >
                  Home
                </a>
              </li>
            ...
            <ul className="p-0">
              <li className="py-[8px] flex justify-center sm:justify-normal">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:text-[#17cf97] flex text-slate-400 gap-2"
                >
              ...
              <li className="py-[8px] flex justify-center sm:justify-normal">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:text-[#17cf97] group flex text-slate-400 gap-2"
                >
              ...
              <li className="py-[8px] flex justify-center sm:justify-normal">
                <a
                  ...
                  className="hover:text-[#17cf97] group flex text-slate-400 gap-2"
                >
                  <FaLocationDot size={30}/><span className="text-left">SCF-165, Sector 9, Faridabad, Haryana 121006</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          ...
          <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            <a
              ...
              href="#"
              title="Email"
              className="hover:text-[#17cf97] flex items-center justify-center w-10 h-10 rounded-full text-slate-400"
            >
              <svg
